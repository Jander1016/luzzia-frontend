...
export function LineChart({ prices, period }: LineChartProps) {
  ...
  // Función para obtener tooltip con información detallada
  ...
  // Configurar dimensiones responsive según dispositivo
  ...
  return (
    <div className="relative w-full">
      ...
      <div className="w-full">
        <svg 
          ref={svgRef}
          className="w-full h-[280px] sm:h-[320px] lg:h-[380px] bg-slate-900/20 rounded-lg"
          viewBox="0 0 800 300"
      ...
      {/* Leyenda de estadísticas optimizada */}
      <div className="mt-6 lg:mt-4">
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 lg:gap-6">
          <div className="bg-slate-800/40 rounded-lg p-3 text-center border border-slate-600/20">
            ...
            <div className="text-red-400 font-mono font-bold text-sm">{formatPrice(maxPrice)}</div>
          </div>
          <div className="bg-slate-800/40 rounded-lg p-3 text-center border border-slate-600/20">
            <div className="text-slate-400 text-xs mb-1">Mínimo</div>
            <div className="text-green-400 font-mono font-bold text-sm">{formatPrice(minPrice)}</div>
          </div>
          <div className="bg-slate-800/40 rounded-lg p-3 text-center border border-slate-600/20">
          ...
          {currentPrice && (
            <div className="bg-slate-800/40 rounded-lg p-3 text-center border border-slate-600/20">
              ...
              <div className="text-yellow-400 font-mono font-bold text-sm">{formatPrice(currentPrice)}</div>
            </div>
          )}
        </div>
      </div>
